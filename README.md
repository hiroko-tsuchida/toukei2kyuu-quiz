...
- **図解つき解説** … 正規分布の面積・棄却域・信頼区間・箱ひげ図など、言葉だけでは伝わりにくい33問に図を表示
- **スコア集計** … 最後に正解率と判定を表示

全160問（🟢易50＝10セット・🟡標準50＝10セット・🔴難30＝6セット・🟣実践30＝6セット、計32セット）／10分野（1変数データ／2変数データ／時系列データ／データ収集／確率／確率分布／標本分布／推定／仮説検定／回帰・分散分析）。
